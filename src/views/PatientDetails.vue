...
const getPatientDetails = async (patient_uuid) => {
  try {
    ...
    console.log(medicationRecords.value);
  } catch (error) {
      ...
      <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Name</label
                  >
                  <argon-input type="text" v-model="form.name" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Gender</label
                  >
                  <argon-input type="text" v-model="form.gender" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Date of Birth</label
                ...
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >IC Number</label
                  >
                  <argon-input type="text" v-model="form.ic_number" />
                </div>
              </div>
        ...
        <div class="col-md-12 mt-5">
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Medication Records</p>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr v-for="(medication, index) in medicationRecordsDisplay" :key="index">
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{ medication.unit }}</span>
                      </td>
                      ...
                      <!-- <td class="align-middle">
                        <argon-button v-if="patient.patient_uuid" color="dark">
                          <a
                            :href="`patient-details/?uuid=${patient.patient_uuid}`"
                        ...
                        <argon-button v-else color="warning">
